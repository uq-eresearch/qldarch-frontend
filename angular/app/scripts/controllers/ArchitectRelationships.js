...
angular.module('angularApp')
    .controller('ArchitectRelationshipsCtrl', function ($scope, architect, interviews, data, GraphHelper) {
    ...
    // $scope.selected = architect;
    // $scope.selectedRelationships = data.relationships;
