...
Ext.apply(lore.ore.model.OntologyManager.prototype, {
    ...
    getDCTypeVocab : function(){
       if (!this.dctypeVocab){
            ...
            this.dctypeVocab = [
               ['http://austlit.edu.au/owl/austlitore.owl#Academic','Academic'],
               ['http://austlit.edu.au/owl/austlitore.owl#Government_Institutions','Government Institutions'],
               ['http://austlit.edu.au/owl/austlitore.owl#Place','Place'],
               ['http://austlit.edu.au/owl/austlitore.owl#Professional','Professional'],
