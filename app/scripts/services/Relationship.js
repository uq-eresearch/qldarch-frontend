...
angular.module('qldarchApp').factory(
    'Relationship',
    function($http, $q, Uris, Request, Entity, Ontology, GraphHelper) {
      ...
      return {
        ...
        findByEntityUri : function(uri) {
          var relationships = [];
          var promises = [ $http.get(Uris.JSON_ROOT + 'annotation/relationship?object=' + encodeURIComponent(uri)),
