    ...
    function Timeline(Uris) {
      ...
      this.relationshipsToEvents = function(relationships, entity) {
        ...
        angular.forEach(relationships, function(relationship) {
          ...
          timelineDate.headline = relationship.subject.name + ' ' + relationship.predicate[Uris.QA_LABEL].toLowerCase() + ' ' +
          ...
          dates.push(addToTimelineDate(timelineDate, ((entity && (relationship.subject.uri === entity.uri)) ? relationship.object
