...
angular.module('qldarchApp').factory('Solr', function(Entity, GraphHelper, Expression, Uris, $q, $http, $filter) {
   ...
   * 
   * @param {String}
   *          text The text to create the snippet from
   * @param {Array}
   *          terms An array of terms to look for in the text
   * @return {String}
   */
