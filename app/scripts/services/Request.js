...
angular.module('qldarchApp').factory('Request', function Request(Uris, $http, $q, GraphHelper) {
  ...
  var request = {
     ...
     * 
     * @param resource
     *          e.g. qldarch:Architect
     * @param type
     *          e.g. entity, expression
     * @param summary
     *          true or false
     * @param subclass
     *          true or false
     ...
     * 
     * @param resource
     *          The type of resource e.g. entity, expression, file,
     *          annotation/evidence
     * @param {Array}uris
     *          An array of uris
