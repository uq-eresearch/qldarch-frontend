...
angular.module('qldarchApp').config(
    function($stateProvider) {
      $stateProvider.state('other.interview', {
        ...
        resolve : {
          interview : [ '$http', '$stateParams', '$q', 'Uris', 'Interview', 'Transcript', 'Relationship', 'GraphHelper', 'Entity', 'Ontology',
              'File', function($http, $stateParams, $q, Uris, Interview, Transcript, Relationship, GraphHelper, Entity, Ontology) {
